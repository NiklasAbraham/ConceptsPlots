...
\begin{frame}[plain]
    \begin{tikzpicture}[remember picture, overlay]
        ...
        % Coffee cup illustration (positioned above the main decorative circle)
        \node[anchor=center] at ([yshift=2.125cm]current page.center) {
            \begin{tikzpicture}[scale=1.0]
                % Cup body (trapezoid shape - wider at top)
                \fill[TuebingenGold!15] (-0.6,0) -- (-0.75,0) -- (-0.9,1.8) -- (-0.9,2.1) -- (0.9,2.1) -- (0.9,1.8) -- (0.75,0) -- (0.6,0) -- cycle;
                \draw[TuebingenGold, line width=2.5pt] (-0.6,0) -- (-0.75,0) -- (-0.9,1.8) -- (-0.9,2.1) -- (0.9,2.1) -- (0.9,1.8) -- (0.75,0) -- (0.6,0) -- cycle;
                ...
                % Saucer (optional, adds realism)
                \fill[TuebingenGold!10] (-1.1,-0.15) ellipse (1.1 and 0.2);
                \draw[TuebingenGold, line width=2pt] (-1.1,-0.15) ellipse (1.1 and 0.2);
                \draw[TuebingenGold!30, line width=1pt] (-0.6,-0.15) ellipse (0.6 and 0.15);
        ...
        % Subtitle with decorative elements (centered below circle)
        \node[anchor=center, align=center] at ([yshift=-1.5cm]current page.center) {
            {\Large \color{TuebingenAnthrazit} Take a moment to refresh}
            \\[0.3cm]
            {\normalsize \color{TuebingenGray} We'll resume shortly}
        };
