...
\begin{frame}[plain]
    \begin{tikzpicture}[remember picture, overlay]
        ...
        % Coffee cup illustration (simplified)
        \node[anchor=center] at ([yshift=1.5cm]current page.center) {
            \begin{tikzpicture}[scale=1.2]
                % Cup body
                \fill[TuebingenGold!20] (0,0) -- (-0.8,0) -- (-0.8,1.5) arc (180:0:0.8) -- (0.8,0) -- cycle;
                \draw[TuebingenGold, line width=2pt] (0,0) -- (-0.8,0) -- (-0.8,1.5) arc (180:0:0.8) -- (0.8,0);
                % Handle
                \draw[TuebingenGold, line width=2pt] (0.8,1.2) .. controls (1.2,1.2) and (1.2,0.8) .. (0.8,0.8);
                % Steam lines
                \draw[TuebingenGold!60, line width=1.5pt] (-0.3,1.5) .. controls (-0.4,2) and (-0.2,2.2) .. (-0.3,2.5);
                \draw[TuebingenGold!60, line width=1.5pt] (0,1.5) .. controls (0.1,2) and (-0.1,2.2) .. (0,2.5);
                \draw[TuebingenGold!60, line width=1.5pt] (0.3,1.5) .. controls (0.4,2) and (0.2,2.2) .. (0.3,2.5);
            \end{tikzpicture}
        };
        ...
        \node[anchor=center, align=center] at ([yshift=-2cm]current page.center) {
        ...
        % Decorative dots
        \foreach \x in {-2, 0, 2} {
            \fill[TuebingenGold] ([xshift=\x cm, yshift=-3.5cm]current page.center) circle (0.15cm);
        }
    \end{tikzpicture}
\end{frame}
