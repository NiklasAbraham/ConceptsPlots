...
\begin{frame}[plain]
    \begin{tikzpicture}[overlay]
        % Decorative circles in background (all shifted 6cm lower and 1cm to the left)
        \fill[TuebingenGold!10] ([xshift=-1cm, yshift=-6cm]current page.center) circle (4cm);
        \fill[TuebingenGold!5] ([xshift=-3cm-1cm, yshift=2cm-6cm]current page.center) circle (2cm);
        \fill[TuebingenGold!5] ([xshift=3cm-1cm, yshift=-2cm-6cm]current page.center) circle (2cm);
        
        % Coffee cup illustration (shifted 6cm lower and 1cm to the left)
        \node[anchor=center] at ([xshift=-1cm, yshift=1.125cm-6cm]current page.center) {
        ...
        % Subtitle with decorative elements (shifted 6cm lower and 1cm to the left)
        \node[anchor=center, align=center] at ([xshift=-1cm, yshift=-2.5cm-6cm]current page.center) {
            {\Large \color{TuebingenAnthrazit} Take a moment to refresh}
            \\[0.3cm]
            {\normalsize \color{TuebingenGray} We'll resume shortly}
        };
        
        % Main title in top left corner (shifted 6cm lower and 1cm to the left)
        \node[anchor=north west, align=left] at ([xshift=0.5cm-1cm, yshift=-0.5cm-6cm]current page.north west) {
