...
\begin{frame}{Purpose of This Act}
    \framesubtitle{Apply Act II's technical foundation to templates executives can fund, govern, and scale.}
    \vspace{0.3em}
...
\begin{frame}{Knowledge Assistant: Risks \& Mitigations (1/2)}
    \framesubtitle{Data and Generation Risks}
    \vspace{0.3em}
    \begin{columns}[T]
        \column{0.48\textwidth}
...
\begin{frame}{Knowledge Assistant: Risks \& Mitigations (2/2)}
    \framesubtitle{Lifecycle and Adoption Risks}
    \vspace{0.3em}
    \begin{columns}[T]
        \column{0.48\textwidth}
