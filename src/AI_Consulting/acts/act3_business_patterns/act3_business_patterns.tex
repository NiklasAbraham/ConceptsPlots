...
\begin{frame}{Customer Support: Compliance Constraints}
    \framesubtitle{Guardrails for customer-facing AI}
    
    \vspace{0.5em}
    {\color{TuebingenRot}\textbf{Compliance Requirements:}}
    \begin{itemize}
        \setlength\itemsep{0.6em}
        \item \textbf{Regulated industries:} Financial advice, medical, legal — AI suggests, human approves
        \item \textbf{PII handling:} Don't expose customer data in logs or outputs
        \item \textbf{Promises:} AI cannot make commitments on behalf of the company
        \item \textbf{Disclaimers:} Required disclosures in regulated contexts
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Tone guidelines and brand voice consistency
        \item Prohibited topics list
        \item Approved response templates for sensitive issues
    \end{itemize}
\end{frame}

\begin{frame}{Customer Support: Escalation Rules}
    \framesubtitle{When to hand off to humans}
    
    \vspace{0.5em}
    \textbf{Escalation Triggers:}
    \begin{itemize}
        \setlength\itemsep{0.6em}
        \item \textbf{Sentiment:} Angry or frustrated customer → human agent
        \item \textbf{Complexity:} Multi-issue or edge case → human agent
        \item \textbf{Risk:} Legal threat → human + legal team
        \item \textbf{Value:} High-value customer → human agent
        \item \textbf{Uncertainty:} Low confidence score → human agent
    \end{itemize}
    
    \vspace{0.5em}
    \begin{theorembox}{Golden Rule}
        When in doubt, escalate. \\
        The cost of over-escalation is always less than the cost of a wrong answer.
    \end{theorembox}
\end{frame}

\begin{frame}{Customer Support: Efficiency Metrics}
    \framesubtitle{Measuring operational impact}
    
    \vspace{0.5em}
    \textbf{Core Efficiency Metrics:}
    \begin{itemize}
        \setlength\itemsep{0.6em}
        \item \textbf{Average Handle Time (AHT):}
        \begin{itemize}
            \item Target: 15-30\% reduction
            \item Measure: Time from ticket open to close
        \end{itemize}
        \item \textbf{First Contact Resolution (FCR):}
        \begin{itemize}
            \item Target: 5-10\% improvement
            \item Measure: Issues resolved without transfer
        \end{itemize}
        \item \textbf{Agent Utilization:}
        \begin{itemize}
            \item More tickets handled per agent
            \item Less time spent searching for information
        \end{itemize}
    \end{itemize}
\end{frame}

\begin{frame}{Customer Support: Quality Metrics}
    \framesubtitle{Ensuring answers are correct}
    ...
    \begin{itemize}
        ...
        \item \textbf{Error Rate:} Wrong answers caught in review
    ...
    \begin{itemize}
        ...
        \item Time saved per AI suggestion
        \item Retrieval accuracy
    \end{itemize}
    
    \vspace{0.3em}
    {\color{TuebingenGray}\textbf{Warning:} Don't optimize AHT at the expense of quality. Balance is key.}
\end{frame}
...
\begin{frame}{Document Automation: Cost Drivers}
    \framesubtitle{Understanding the current state}
    
    \vspace{0.5em}
    \textbf{Current State Cost Drivers:}
    \begin{itemize}
        \setlength\itemsep{0.5em}
        ...
        \item Missed discounts from late payments
    \end{itemize}
    
    \vspace{0.5em}
    \textbf{Example: Invoice Processing Baseline}
    \begin{itemize}
        \setlength\itemsep{0.5em}
        \item 50,000 invoices per year
        \item \$15 cost per manually processed invoice
        \item Total baseline cost: \$750,000/year
    \end{itemize}
\end{frame}

\begin{frame}{Document Automation: ROI Calculation}
    \framesubtitle{Quantifying the benefits}
    
    \vspace{0.5em}
    \textbf{Automation Benefits:}
    \begin{itemize}
        \setlength\itemsep{0.5em}
        \item 80\% straight-through processing (no human touch)
        \item 70\% cost reduction per automated invoice
    ...
    \begin{itemize}
        ...
        \item Exceptions (human): 10,000 × \$18 = \$180K
        \item New total cost: \$340K
        \item \textbf{Annual savings: \$410K (55\%)}
    \end{itemize}
